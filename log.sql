CREATE TABLE Kvarter(kvarter_id varchar(20) NOT NULL,
	kommun varchar(100),
	trakt varchar(100),
	block_nr int,
	enhet int,
	PRIMARY KEY (kvarter_id)
);


CREATE TABLE Adress(adress_id varchar(150) NOT NULL,
	kvarter_id varchar(20),
	gatunamn varchar(100),
	gatunummer int,
	PRIMARY KEY (adress_id),
	FOREIGN KEY (kvarter_id) REFERENCES Kvarter(kvarter_id)
);


CREATE TABLE Lägenhetshus(lägenhetshus_id varchar(20) NOT NULL,
	adress_id varchar(150) NOT NULL,
	ordnings_namn varchar(100),
	PRIMARY KEY (lägenhetshus_id),
	FOREIGN KEY (adress_id) REFERENCES Adress(adress_id),
	CONSTRAINT unique_id UNIQUE (ordnings_namn)
);


CREATE TABLE Våningsplan(våning_id varchar(100) NOT NULL,
	lägenhetshus_id varchar(20) NOT NULL,
	plan_nr varchar(50),
	PRIMARY KEY (våning_id),
	FOREIGN KEY (lägenhetshus_id) REFERENCES Lägenhetshus(lägenhetshus_id),
	CONSTRAINT unique_plan_nr UNIQUE (plan_nr)
);


CREATE TABLE Lägenhet(lgh_id varchar(30) NOT NULL,
	våning_id varchar(100) NOT NULL,
	lgh_nr varchar(30),
	antal_rum int,
	area_kvm int,
	PRIMARY KEY (lgh_id),
	FOREIGN KEY (våning_id) REFERENCES Våningsplan(våning_id),
	CONSTRAINT unique_lgh_nr UNIQUE (lgh_nr)
);


CREATE TABLE Avtal(avtal_id varchar(20) NOT NULL,
	lgh_id varchar(30) NOT NULL,
	månadshyra money,
	start_datum date,
	slut_datum date,
	årshyra money,
	PRIMARY KEY (avtal_id),
	FOREIGN KEY (lgh_id) REFERENCES Lägenhet(lgh_id)
);


CREATE TABLE Person(person_id varchar(30) NOT NULL,
	...
	FOREIGN KEY (avtal_id) REFERENCES Avtal(avtal_id),
);
...
ALTER TABLE Lägenhet
	ADD FOREIGN KEY(avtal_id) REFERENCES Avtal(avtal_id);

-- Time to insert values into columns

INSERT INTO Kvarter (kvarter_id, kommun, trakt, block_nr, enhet)
VALUES ('BJRN-1', 'Vallentuna', 'Björnen', 12, 10);

INSERT INTO Adress(adress_id, kvarter_id, gatunamn, gatunummer)
VALUES ('BJRN-ADRESS-1', 'BJRN-1', 'Rosenlundsgatan', 10)

INSERT INTO Lägenhetshus(lägenhetshus_id, adress_id, ordnings_namn)
VALUES ('BJRN-HUS-1', 'BJRN-ADRESS-1', 'Björnen, Hus Trästocken')

INSERT INTO Våningsplan(våning_id, lägenhetshus_id, plan_nr)
VALUES ('Trästocken-Vån-1', 'BJRN-HUS-1', 'Trästocken, plan #1')

--

INSERT INTO Lägenhet(lgh_id, våning_id, lgh_nr, antal_rum, area_kvm)
...
-- Skapar avtal 1
INSERT INTO Avtal(avtal_id, lgh_id, månadshyra, start_datum, slut_datum, årshyra)
...
WHERE lgh_id = 'TRÄ-1101';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1102'
WHERE lgh_id = 'TRÄ-1102';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1103'
WHERE lgh_id = 'TRÄ-1103';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1104'
WHERE lgh_id = 'TRÄ-1104';

-- 
INSERT INTO Person(person_id, first_name, last_name, email, telefon_nr, avtal_id)
...
WHERE lgh_id = 'TRÄ-1201';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1202'
WHERE lgh_id = 'TRÄ-1202';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1203'
WHERE lgh_id = 'TRÄ-1203';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-TRÄ-1204'
WHERE lgh_id = 'TRÄ-1204';
...
WHERE lgh_id = 'FGL-1101';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FGL-1102'
WHERE lgh_id = 'FGL-1102';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FGL-1103'
WHERE lgh_id = 'FGL-1103';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FGL-1104'
WHERE lgh_id = 'FGL-1104';
...
--
-- Dags att skapa tabell Archived_Avtal

CREATE TABLE Archived_avtal(avtal_id varchar(20) NOT NULL,
	lgh_id varchar(30) NOT NULL,
	månadshyra money,
	start_datum date,
	slut_datum date,
...
SELECT * FROM Avtal 
WHERE avtal_id = 'Avtal-FGL-1101';


-- Tar bort gammalt avtal från hyresgäst & lägenheten
UPDATE Person
SET avtal_id = NULL
WHERE person_id = '19960303-7838';

UPDATE Lägenhet
SET avtal_id = NULL
WHERE lgh_nr = 'FGL-LGH 1101';

DELETE FROM Avtal WHERE avtal_id = 'Avtal-FGL-1101';
...
WHERE lgh_id = 'BRR-1101';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-BRR-1102'
WHERE lgh_id = 'BRR-1102';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-BRR-1103'
WHERE lgh_id = 'BRR-1103';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-BRR-1104'
WHERE lgh_id = 'BRR-1104';
...
WHERE lgh_id = 'BRR-1201';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-BRR-1202'
WHERE lgh_id = 'BRR-1202';
...
WHERE lgh_id = 'FRÖ-1101';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FRÖ-1102'
WHERE lgh_id = 'FRÖ-1102';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FRÖ-1201'
WHERE lgh_id = 'FRÖ-1201';

UPDATE Lägenhet 
SET avtal_id = 'Avtal-FRÖ-1202'
WHERE lgh_id = 'FRÖ-1202';
...
WHERE lägenhetshus_id = 'BJRN-HUS-1';

UPDATE Lägenhetshus 
SET kvarter_id = 'BJRN-1'
WHERE lägenhetshus_id = 'BJRN-HUS-2';

UPDATE Lägenhetshus 
SET kvarter_id = 'SKTN-1'
WHERE lägenhetshus_id = 'SKTN-HUS-1';

UPDATE Lägenhetshus 
SET kvarter_id = 'SKTN-1'
WHERE lägenhetshus_id = 'SKTN-HUS-2';
...
FROM Person p
LEFT JOIN Avtal a on p.avtal_id = a.avtal_id 
LEFT JOIN Lägenhet l on a.lgh_id = l.lgh_id  
ORDER BY p.first_name;

-- 4.2
SELECT k.kvarter_id, k.kommun, k.trakt, k.block_nr, k.enhet, l.antal_rum, l.area_kvm

LEFT JOIN Lägenhet l



/*
SELECT k.kvarter_id, k.kommun, k.trakt, k.block_nr, l2.kvarter_id, k.enhet, l.antal_rum, l.area_kvm,
	SUM(CASE WHEN l2.kvarter_id in ('BJRN-1') THEN END) as Antal-Björnen-Hus
	SUM(CASE WHEN l2.kvarter_id in ('SKTN-1') END) as Antal-Skatan-Hus
FROM Kvarter k 
LEFT JOIN Lägenhet l
LEFT JOIN Lägenhetshus l2 
ORDER BY k.kvarter_id;

---
SELECT SUM(area_kvm) FROM Lägenhet AS total_area
SELECT SUM(antal_rum) FROM Lägenhet AS total_rum 
----
person left join avtal left join lägenhet
----
SELECT Person.first_name
FROM Person
INNER JOIN Hyresgäst_info
ON Person.first_name = Hyresgäst_info.first_name;
SELECT * FROM Hyresgäst_info
------
När man ska göra 4.2, ska man ta in alla värden via en join och sedan när man visar
all data 
Frågor för Johan.
Hur får man fram specifika värden från olika kolumner? Ska man göra en ny tabell
som tar in data och räknar ihop det? Fråga om tips. (Kanske joins? inner joins? right/left joins??)
*/